...
Hence we can fit both ordinary and logistic regression models as follows.
...
coefs_for_table <- cbind.data.frame(gaussian = lm_coefs, logistic = llm_coefs)
...
The logistic model, on the other hand, tells us that an additional 1ug exposure to DDE leads to about $0.9$-increase in the log odds of the probability of delivering a baby prematurely. 
