...
```{r cache=TRUE}
full.lm<- lm(gestational_age~ dde + pcb_028 + pcb_052 + pcb_074 + pcb_153+ pcb_138 + pcb_180 + pcb_194 + pcb_203 + race + triglycerides + cholesterol+ maternal_age + smoking_status + score_education + score_income + score_occupation + center, data=data_age_na)
