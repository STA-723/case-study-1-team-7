...
>>>>>>> 66fe2fa7ead8e0552be733d05f571fa2ce2c2de2
...
# ADD LABELS -- I DO NOT KNOW WHAT IS RACE 1!!!
# TOO MUCH; JUST SHOW ONE OF THE TWO.
# ggplot(data_46,mapping = aes(x=as.factor(center),y=score_income,color=race))+geom_boxplot()+theme_bw()
```

<<<<<<< HEAD
```{r EDA, echo=FALSE, cache=TRUE, include=FALSE, eval=FALSE}
# COULD BE OMITTED. TURNING OFF FOR NOW.
# otherwise set include/eval to true. Will need additional slide.
...
fit(lasso_logistic, new, interval = "prediction")
